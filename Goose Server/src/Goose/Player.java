...
public class Player implements ICharacter {
  ...
  public void addSaveEvent(GameWorld world) throws Exception {
    ...
    if ((world.getTimeNow() - this.getLastPing()) > ((GameSettings.getDefault()
        .getPlayerSavePeriod() * 2.00) * world.getTimerFrequency())) {
      ...
      ev.setPlayer(this);
      ev.setTicks(ev.getTicks()
          + (GameSettings.getDefault().getPlayerSavePeriod() * world.getTimerFrequency()));
      world.getEventHandler().addEvent(ev);
    }
  }
