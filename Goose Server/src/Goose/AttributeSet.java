...
public class AttributeSet {
	...
	public static AttributeSet add(AttributeSet a1, AttributeSet a2)
			throws Exception {
		AttributeSet ret = new AttributeSet();
		ret.setAC(a1.getAC() + a2.getAC());
		ret.setAirResist(a1.getAirResist() + a2.getAirResist());
		ret.setDamageReduction(a1.getDamageReduction()
				+ a2.getDamageReduction());
	...
	public static AttributeSet multiply(AttributeSet a1, double mult)
			throws Exception {
		AttributeSet ret = new AttributeSet();
