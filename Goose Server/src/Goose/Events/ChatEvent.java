 ...
 * 
 * Server responds: ^LoginID, Name: Message Server sends the response to
 * everyone in the area including the player
 * 
 */
public class ChatEvent extends Event {
	...
	public void ready(GameWorld world) throws Exception {
		if (this.getPlayer().getState() == Goose.Player.States.Ready) {
			...
			String packet = "^" + this.getPlayer().getLoginID() + ","
					+ this.getPlayer().getName() + ": " + message;
			String filteredpacket = "^" + this.getPlayer().getLoginID() + ","
