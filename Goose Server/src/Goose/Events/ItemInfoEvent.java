 ...
 * Packet: GIDitemid
 * 
 * Note: if itemid is lessthan GameSettings.Default.ItemIDStartpoint then it's a
 * template id else it's an item id
 * 
 */
...
// if got here log bad GID packet since they have no open vendors with that
// template id