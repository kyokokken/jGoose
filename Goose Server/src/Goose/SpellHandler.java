...
public class SpellHandler {
  ...
  public void loadSpellEffects(GameWorld world) throws Exception {
    ...
    while (resultSet.next()) {
      ...
      effect
          .setDisplay(Goose.SpellEffect.SpellDisplays.values()[resultSet.getInt("spell_display")]);
      ...
      effect.setEffected(Goose.SpellEffect.SpellEffected.values()[resultSet
          .getInt("spell_effected")]);
      ...
      effect.setDoAttackAnimation(("0".equals(resultSet.getString("do_attack_animation"))
          ? false
          : true));
      effect.setSpellDamageEffects(("0".equals(resultSet.getString("spell_damage_effects"))
          ? false
          : true));
      ...
      effect
          .setBuffCanBeRemoved(("0".equals(resultSet.getString("buff_removable")) ? false : true));
      ...
      effect.setOnMeleeAttackSpellChance(Double.parseDouble(resultSet
          .getString("on_attack_spell_chance")));
      effect.setOnMeleeHitSpellID(resultSet.getInt("on_hit_spell_effect_id"));
      effect
          .setOnMeleeHitSpellChance(Double.parseDouble(resultSet.getString("on_hit_spell_chance")));
      ...
      effect.setBuffStacksOver(new ArrayList<SpellEffect>());
      effect.setBuffDoesntStackOver(new ArrayList<SpellEffect>());
      effect
          .setOnlyHitsOneNPC(("0".equals(resultSet.getString("only_hits_one_npc")) ? false : true));
  ...
  public SpellEffect getSpellEffect(int id) throws Exception {
    return (SpellEffect) this.effects.get(id);
  }
  ...
  public Spell getSpell(int id) throws Exception {
    return (Spell) this.spells.get(id);
  }
