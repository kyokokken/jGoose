...
public class GameWorld {
  ...
  public void start() throws Exception {
    ...
    try {
      String connectionString =
          "jdbc:mysql://" + GameSettings.getDefault().getDatabaseAddress() + "/"
              ...
              + GameSettings.getDefault().getDatabasePassword();
    ...
    System.out.println(String.valueOf(this.getGuildHandler().getCount()) + " guilds loaded.");
    ...
    System.out.println(String.valueOf(this.getSpellHandler().getEffectCount())
    ...
    System.out.println(String.valueOf(this.getSpellHandler().getCount()) + " spells loaded.");
    ...
    System.out.println(String.valueOf(this.getItemHandler().getTemplateCount())
    ...
    System.out.println(String.valueOf(this.getItemHandler().getItemCount()) + " items loaded.");
    ...
    System.out.println(String.valueOf(this.getMapHandler().getCount()) + " maps loaded.");
    ...
    System.out.println(String.valueOf(this.getClassHandler().getCount()) + " classes loaded.");
    ...
    System.out.println(String.valueOf(this.getNPCHandler().getTemplateCount())
    ...
    System.out.println(String.valueOf(this.getNPCHandler().getNPCCount()) + " NPCs spawned.");
    ...
    System.out.println(String.valueOf(this.getCombinationHandler().getCount())
        + " combinations loaded.");
    ...
    System.out.println(String.valueOf(this.getChatFilter().getCount()) + " words loaded.");
    ...
    System.out.println(String.valueOf(this.getPlayerHandler().getPlayerDataCount())
        + " players loaded.");
  ...
  public void newConnection(Socket sock) throws Exception {
    System.out.println("Connection attempt: " + sock.getInetAddress().getHostAddress());
  }
  ...
  public void lostConnection(Socket sock) throws Exception {
    try {
      System.out.println("Connection lost: " + sock.getInetAddress().getHostAddress());
