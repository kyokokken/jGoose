//
// Translated by CS2J (http://www.cs2j.com): 15/11/2013 18:39:01
//
...
public class ItemTile   implements ITile
{
    ...
    public String mOBString() throws Exception {
        ...
        {
            rgba = this.getItemSlot().getItem().getGraphicR() + "," + this.getItemSlot().getItem().getGraphicG() + "," + this.getItemSlot().getItem().getGraphicB() + "," + this.getItemSlot().getItem().getGraphicA();
        }
         
        return "MOB" + this.getItemSlot().getItem().getGraphicTile() + "," + this.getX() + "," + this.getY() + "," + this.getItemSlot().getItem().getName() + (this.getItemSlot().getItem().getIsBindOnPickup() ? " (BoP)" : "") + "," + this.getItemSlot().getStack() + "," + rgba;
    }
